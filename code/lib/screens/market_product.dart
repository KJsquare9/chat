...
class _ProductDetailsPageState extends State<ProductDetailsPage> {
  ...
  List<Uint8List> getProductImages() {
    ...
    if (widget.product.containsKey('images') && widget.product['images'] != null) {
        ...
        Padding(
            ...
            child: SizedBox(
              ...
              child: ElevatedButton(
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) => ChatPage(
                        sellerName: widget.product['seller_name'] ?? 'Seller',
                      ),
                    ),
                  );
                },
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween, // Align at ends
                  children: [
                    Row(
                      children: [
